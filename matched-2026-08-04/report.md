...
- After: `43d2224552757752960788ba2023c3ba2964d5f2` (PR head)
...
| Floating/async channel | No counterpart in this diff | `ErrorBannerView` on `.regularMaterial` | **Android still has no equivalent floating channel** | Pre-existing; PR defers it to phase 4 (`Snackbar`) |
